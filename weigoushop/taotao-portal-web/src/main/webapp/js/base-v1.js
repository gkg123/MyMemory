 ...
 */
function login() {
    return location.href = "http://localhost:8099/page/login";
}
function regist() {
    return location.href = "http://localhost:8099/page/register";
}
...
function search(a) {
    var b = "http://localhost:8096/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
